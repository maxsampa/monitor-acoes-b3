...
# Altere aqui a senha desejada. Nunca deixe visível no Telegram.
# ============================================================
...
def executar_check(chat_id: str, ticker: str):
    ...
    _enviar_mensagem_fatiada(chat_id, msg, parse_mode="HTML")
    print(
...
def _enviar_mensagem_fatiada(chat_id: str, texto: str,
    ...
    if len(texto) <= tamanho_max:
        _enviar_mensagem(chat_id, texto, parse_mode=parse_mode)
        return
